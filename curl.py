...
#payload = '{"gage_id": "01123000", "domain":"CONUS", "source":"USGS", "modules": ["CFE-S"]}'
#payload = '{"gage_id": "06710385", "domain":"CONUS", "source":"USGS", "modules": ["LASAM"]}'
payload = '{"gage_id": "01123000", "domain":"CONUS", "source":"USGS", "modules": ["UEB"]}'
...
#payload = '{"gage_id": "01027200", "domain":"CONUS", "source":"USGS", "modules": ["SFT", "CFE-S", "Noah-OWP-Modular", "SNOW-17"]}'

#payload = '{"gage_id": "01011000", "domain":"CONUS", "source":"USGS", "modules": ["CFE-S"]}'
#payload = '{"gage_id": "01031510", "domain":"CONUS", "source":"USGS", "modules": ["CFE-X"]}'
"""
